...
Route::middleware('auth')->group(function () {
    ...
    // Shelves
    Route::get('/create-hub', [EntityControllers\BookshelfController::class, 'create']);
    Route::get('/hubs/', [EntityControllers\BookshelfController::class, 'index']);
    Route::post('/hubs/', [EntityControllers\BookshelfController::class, 'store']);
    Route::get('/hubs/{slug}/edit', [EntityControllers\BookshelfController::class, 'edit']);
    Route::get('/hubs/{slug}/delete', [EntityControllers\BookshelfController::class, 'showDelete']);
    Route::get('/hubs/{slug}', [EntityControllers\BookshelfController::class, 'show']);
    Route::put('/hubs/{slug}', [EntityControllers\BookshelfController::class, 'update']);
    Route::delete('/hubs/{slug}', [EntityControllers\BookshelfController::class, 'destroy']);
    Route::get('/hubs/{slug}/permissions', [PermissionsController::class, 'showForShelf']);
    Route::put('/hubs/{slug}/permissions', [PermissionsController::class, 'updateForShelf']);
    Route::post('/hubs/{slug}/copy-permissions', [PermissionsController::class, 'copyShelfPermissionsToBooks']);
    Route::get('/hubs/{slug}/references', [ReferenceController::class, 'shelf']);

    // Book Creation
    Route::get('/hubs/{hubSlug}/create-document', [EntityControllers\BookController::class, 'create']);
    Route::post('/hubs/{hubSlug}/create-document', [EntityControllers\BookController::class, 'store']);
    Route::get('/create-document', [EntityControllers\BookController::class, 'create']);

    // Books
    Route::get('/documents/', [EntityControllers\BookController::class, 'index']);
    Route::post('/documents/', [EntityControllers\BookController::class, 'store']);
    Route::get('/documents/{slug}/edit', [EntityControllers\BookController::class, 'edit']);
    Route::put('/documents/{slug}', [EntityControllers\BookController::class, 'update']);
    Route::delete('/documents/{id}', [EntityControllers\BookController::class, 'destroy']);
    Route::get('/documents/{slug}/sort-item', [SortingControllers\BookSortController::class, 'showItem']);
    Route::get('/documents/{slug}', [EntityControllers\BookController::class, 'show']);
    Route::get('/documents/{bookSlug}/permissions', [PermissionsController::class, 'showForBook']);
    Route::put('/documents/{bookSlug}/permissions', [PermissionsController::class, 'updateForBook']);
    Route::get('/documents/{slug}/delete', [EntityControllers\BookController::class, 'showDelete']);
    Route::get('/documents/{bookSlug}/copy', [EntityControllers\BookController::class, 'showCopy']);
    Route::post('/documents/{bookSlug}/copy', [EntityControllers\BookController::class, 'copy']);
    Route::post('/documents/{bookSlug}/convert-to-shelf', [EntityControllers\BookController::class, 'convertToShelf']);
    Route::get('/documents/{bookSlug}/sort', [SortingControllers\BookSortController::class, 'show']);
    Route::put('/documents/{bookSlug}/sort', [SortingControllers\BookSortController::class, 'update']);
    Route::get('/documents/{slug}/references', [ReferenceController::class, 'book']);
    Route::get('/documents/{bookSlug}/export/html', [ExportControllers\BookExportController::class, 'html']);
    Route::get('/documents/{bookSlug}/export/pdf', [ExportControllers\BookExportController::class, 'pdf']);
    Route::get('/documents/{bookSlug}/export/markdown', [ExportControllers\BookExportController::class, 'markdown']);
    Route::get('/documents/{bookSlug}/export/zip', [ExportControllers\BookExportController::class, 'zip']);
    Route::get('/documents/{bookSlug}/export/plaintext', [ExportControllers\BookExportController::class, 'plainText']);

    // Pages
    Route::get('/documents/{bookSlug}/create-page', [EntityControllers\PageController::class, 'create']);
    Route::post('/documents/{bookSlug}/create-guest-page', [EntityControllers\PageController::class, 'createAsGuest']);
    Route::get('/documents/{bookSlug}/draft/{pageId}', [EntityControllers\PageController::class, 'editDraft']);
    Route::post('/documents/{bookSlug}/draft/{pageId}', [EntityControllers\PageController::class, 'store']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}', [EntityControllers\PageController::class, 'show']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/export/pdf', [ExportControllers\PageExportController::class, 'pdf']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/export/html', [ExportControllers\PageExportController::class, 'html']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/export/markdown', [ExportControllers\PageExportController::class, 'markdown']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/export/plaintext', [ExportControllers\PageExportController::class, 'plainText']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/export/zip', [ExportControllers\PageExportController::class, 'zip']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/edit', [EntityControllers\PageController::class, 'edit']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/move', [EntityControllers\PageController::class, 'showMove']);
    Route::put('/documents/{bookSlug}/page/{pageSlug}/move', [EntityControllers\PageController::class, 'move']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/copy', [EntityControllers\PageController::class, 'showCopy']);
    Route::post('/documents/{bookSlug}/page/{pageSlug}/copy', [EntityControllers\PageController::class, 'copy']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/delete', [EntityControllers\PageController::class, 'showDelete']);
    Route::get('/documents/{bookSlug}/draft/{pageId}/delete', [EntityControllers\PageController::class, 'showDeleteDraft']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/permissions', [PermissionsController::class, 'showForPage']);
    Route::put('/documents/{bookSlug}/page/{pageSlug}/permissions', [PermissionsController::class, 'updateForPage']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/references', [ReferenceController::class, 'page']);
    Route::put('/documents/{bookSlug}/page/{pageSlug}', [EntityControllers\PageController::class, 'update']);
    Route::delete('/documents/{bookSlug}/page/{pageSlug}', [EntityControllers\PageController::class, 'destroy']);
    Route::delete('/documents/{bookSlug}/draft/{pageId}', [EntityControllers\PageController::class, 'destroyDraft']);

    // Revisions
    Route::get('/documents/{bookSlug}/page/{pageSlug}/revisions', [EntityControllers\PageRevisionController::class, 'index']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/revisions/{revId}', [EntityControllers\PageRevisionController::class, 'show']);
    Route::get('/documents/{bookSlug}/page/{pageSlug}/revisions/{revId}/changes', [EntityControllers\PageRevisionController::class, 'changes']);
    Route::put('/documents/{bookSlug}/page/{pageSlug}/revisions/{revId}/restore', [EntityControllers\PageRevisionController::class, 'restore']);
    Route::delete('/documents/{bookSlug}/page/{pageSlug}/revisions/{revId}/delete', [EntityControllers\PageRevisionController::class, 'destroy']);
    Route::delete('/page-revisions/user-drafts/{pageId}', [EntityControllers\PageRevisionController::class, 'destroyUserDraft']);

    // Chapters
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/create-page', [EntityControllers\PageController::class, 'create']);
    Route::post('/documents/{bookSlug}/chapter/{chapterSlug}/create-guest-page', [EntityControllers\PageController::class, 'createAsGuest']);
    Route::get('/documents/{bookSlug}/create-chapter', [EntityControllers\ChapterController::class, 'create']);
    Route::post('/documents/{bookSlug}/create-chapter', [EntityControllers\ChapterController::class, 'store']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}', [EntityControllers\ChapterController::class, 'show']);
    Route::put('/documents/{bookSlug}/chapter/{chapterSlug}', [EntityControllers\ChapterController::class, 'update']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/move', [EntityControllers\ChapterController::class, 'showMove']);
    Route::put('/documents/{bookSlug}/chapter/{chapterSlug}/move', [EntityControllers\ChapterController::class, 'move']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/copy', [EntityControllers\ChapterController::class, 'showCopy']);
    Route::post('/documents/{bookSlug}/chapter/{chapterSlug}/copy', [EntityControllers\ChapterController::class, 'copy']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/edit', [EntityControllers\ChapterController::class, 'edit']);
    Route::post('/documents/{bookSlug}/chapter/{chapterSlug}/convert-to-book', [EntityControllers\ChapterController::class, 'convertToBook']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/permissions', [PermissionsController::class, 'showForChapter']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/export/pdf', [ExportControllers\ChapterExportController::class, 'pdf']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/export/html', [ExportControllers\ChapterExportController::class, 'html']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/export/markdown', [ExportControllers\ChapterExportController::class, 'markdown']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/export/plaintext', [ExportControllers\ChapterExportController::class, 'plainText']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/export/zip', [ExportControllers\ChapterExportController::class, 'zip']);
    Route::put('/documents/{bookSlug}/chapter/{chapterSlug}/permissions', [PermissionsController::class, 'updateForChapter']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/references', [ReferenceController::class, 'chapter']);
    Route::get('/documents/{bookSlug}/chapter/{chapterSlug}/delete', [EntityControllers\ChapterController::class, 'showDelete']);
    Route::delete('/documents/{bookSlug}/chapter/{chapterSlug}', [EntityControllers\ChapterController::class, 'destroy']);
